...
{  
    public class WeaponInitializeSystem : IInitializeSystem
    {
        ...
        {
            _currentCharacterWeaponsData.CurrentWeaponViewLeft.Value = _weaponFactory.Create(WeaponType.Shotgun, _characterView.LeftWeaponPlacer);
            _currentCharacterWeaponsData.CurrentWeaponViewRight.Value = _weaponFactory.Create(WeaponType.Shotgun, _characterView.RightWeaponPlacer);
        }
    }
}