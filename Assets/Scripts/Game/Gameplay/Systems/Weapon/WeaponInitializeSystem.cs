...
{  
    public class WeaponInitializeSystem : IInitializeSystem
    {
        ...
        {
            _currentCharacterWeaponsData.CurrentWeaponViewLeft.Value = _weaponFactory.Create(WeaponType.Glock, _characterView.LeftWeaponPlacer);
            _currentCharacterWeaponsData.CurrentWeaponViewRight.Value = _weaponFactory.Create(WeaponType.Glock, _characterView.RightWeaponPlacer);
        }
    }
}